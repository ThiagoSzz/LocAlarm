    ...
    if (eventType === GeofencingEventType.Enter && isRegionIn === -1) {
      ...
      await Notifications.scheduleNotificationAsync({
        content: {
          ...
          body: 'Você chegou ao seu destino ' + region.identifier,
        },
        trigger: { seconds: 1 },
      });
    }
  ...
  return (
    <View style={{ ...styles.card, backgroundColor: colors.primaryBackground }}>
      ...
      <View style={styles.cardContent}>
        <Text
          style={{ ...styles.cardTitle, color: colors.primaryTextAndIcons }}
          numberOfLines={1}>
        ...
        <View
          ...
          <View style={styles.daysOfWeek}>
            <View
              style={{
                ...styles.dayOfWeek,
                backgroundColor: selectedDays.includes('Dom')
                  ? colors.onColor
                  : colors.offColor,
              }}>
            ...
            <View
              style={{
                ...styles.dayOfWeek,
                backgroundColor: selectedDays.includes('Seg')
                  ? colors.onColor
                  : colors.offColor,
              }}>
            ...
            <View
              style={{
                ...styles.dayOfWeek,
                backgroundColor: selectedDays.includes('Ter')
                  ? colors.onColor
                  : colors.offColor,
              }}>
            ...
            <View
              style={{
                ...styles.dayOfWeek,
                backgroundColor: selectedDays.includes('Qua')
                  ? colors.onColor
                  : colors.offColor,
              }}>
            ...
            <View
              style={{
                ...styles.dayOfWeek,
                backgroundColor: selectedDays.includes('Qui')
                  ? colors.onColor
                  : colors.offColor,
              }}>
              <Text style={styles.dayOfWeekText}>Q</Text>
            ...
            <View
              style={{
                ...styles.dayOfWeek,
                backgroundColor: selectedDays.includes('Sex')
                  ? colors.onColor
                  : colors.offColor,
              }}>
              <Text style={styles.dayOfWeekText}>S</Text>
            ...
            <View
              style={{
                ...styles.dayOfWeek,
                backgroundColor: selectedDays.includes('Sab')
                  ? colors.onColor
                  : colors.offColor,
              }}>
              <Text style={styles.dayOfWeekText}>S</Text>
      ...
      <View style={styles.cardActions}>
        ...
        <TouchableOpacity
          ...
          style={{ backgroundColor: 'transparent' }}>
          <Feather
            name={toggle ? 'toggle-right' : 'toggle-left'}
            size={35}
            color={toggle ? colors.onColor : colors.offColor}
          />
        </TouchableOpacity>
      </View>
...
const HomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    if (newAlarm) {
      ...
      setHistorical([
        ...historical,
        { ...newAlarm, id: localId, createdAt: new Date(newAlarm.createdAt) },
      ]);
    }
  }, [newAlarm]);
  ...
  const showItemHistorical = ({ item }) => {
    return (
      <View
        ...
        <View style={{ flex: 1 }}>
          <Text
            style={{ ...styles.alarmName, color: colors.primaryTextAndIcons }}>
            {item.name}
          </Text>
          <Text
            style={{
            ...
            Criado em {item.createdAt.toLocaleDateString()} às{' '}
        ...
        <TouchableOpacity>
          <Feather
            name="star"
            onPress={() => historicalToFavorite({ item })}
            size={25}
            color={colors.star}
          />
        </TouchableOpacity>
  ...
  return (
    <View style={{ flex: 1 }}>
      <LinearGradient
        ...
        <View
          ...
          <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
            <TouchableOpacity
              onPress={() => navigation.navigate('Settings', buttonStates)}>
              <Feather
                name="settings"
                size={23}
      ...
      <View style={{ flex: 1, backgroundColor: colors.secondaryBackground }}>
        <View
          style={{ backgroundColor: colors.secondaryBackground, padding: 15 }}>
          <Text
            style={{
              fontSize: 18,
              fontWeight: 'bold',
        ...
        {favorite.length === 0 ? (
          <View
            ...
            <Text
              ...
              Destaque um alarme clicando no ícone "star" 😀
            </Text>
          </View>
        ) : (
          <FlatList
            style={{ paddingHorizontal: 15, height: 300, minHeight: 260 }}
            data={favorite}
            keyExtractor={(item) => item.id.toString()}
            renderItem={showItemFavorite}
            numColumns={2}
          />
        )}
        ...
        {historical.length === 0 ? (
          <View
            ...
            <Text
              ...
              Adicione um novo alarme clicando no ícone "+" ao topo da tela 😉
            </Text>
          </View>
        ) : (
          <FlatList
...
function App() {
  ...
  return (
    <View
      ...
      <StatusBar
        barStyle={isDarkModeOn ? darkTheme.statusBar : lightTheme.statusBar}
      />
      <NavigationContainer>
